...
def parameter_prepared():
    ...
    # 定义模型
    weibo_config.model = TextCNN(weibo_config.input_dim, weibo_config.embedding_dim,weibo_config.n_filter,weibo_config.filter_sizes, weibo_config.output_dim,weibo_config.dropout, weibo_config.pad_idx)
    # 优化器，损失
